...
(function () {
    ...
    OpkBakery.Views.Recipe = Backbone.View.extend({
        ...
        generateScript: function() {
            ...
            script += 'echo \'if [ -f ./' + databasePackage.get('field_package_name') + '/onboot.sh ]; then ./' + databasePackage.get('field_package_name') + '/onboot;fi\' >> autorun.sh \n'
            script += 'echo \'if [ -f ./' + sensorPackage.get('field_package_name') + '/onboot.sh ]; then ./' + sensorPackage.get('field_package_name') + '/onboot;fi\' >> autorun.sh \n'
